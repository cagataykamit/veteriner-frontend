...
@Component({
    selector: 'app-lab-result-new-page',
    standalone: true,
    imports: [
        CommonModule,
        ReactiveFormsModule,
    ...
    template: `
        ...
        <app-page-header title="Yeni lab sonucu" subtitle="Klinik" description="Laboratuvar sonuç kaydı oluşturun." />
            ...
            <form [formGroup]="form" (ngSubmit)="onSubmit()">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-12 md:col-span-6">
                        ...
                        />
                        @if (form.controls.resultDateLocal.invalid && form.controls.resultDateLocal.touched) {
                            <small class="text-red-500">Zorunlu alan.</small>
                        } @else if (apiFieldErrors().resultDateLocal) {
                    ...
                    <div class="col-span-12">
                        ...
                        @if (form.controls.testName.invalid && form.controls.testName.touched) {
                            <small class="text-red-500">Zorunlu alan.</small>
                        } @else if (apiFieldErrors().testName) {
                    ...
                    <div class="col-span-12">
                        ...
                        @if (form.controls.resultText.invalid && form.controls.resultText.touched) {
                            <small class="text-red-500">Zorunlu alan.</small>
                        } @else if (apiFieldErrors().resultText) {
...
export class LabResultNewPageComponent implements OnInit {
    ...
    goList(): void {
        void this.router.navigate(['/panel/lab-results']);
    }
