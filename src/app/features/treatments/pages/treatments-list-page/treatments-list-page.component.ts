...
@Component({
    ...
    template: `
        ...
        <div class="card mb-6">
            <div class="grid grid-cols-12 gap-4 items-end">
                <div class="col-span-12 md:col-span-4">
                    <label for="trSearch" class="block text-sm font-medium text-muted-color mb-2">Arama</label>
                    <input
                        pInputText
                        id="trSearch"
                        class="w-full"
                ...
                <div class="col-span-12 md:col-span-3">
                    <label for="trFrom" class="block text-sm font-medium text-muted-color mb-2">Başlangıç</label>
                    <input id="trFrom" type="date" class="w-full p-inputtext p-component" [(ngModel)]="fromDateInput" />
                </div>
                <div class="col-span-12 md:col-span-3">
                    <label for="trTo" class="block text-sm font-medium text-muted-color mb-2">Bitiş</label>
                    <input id="trTo" type="date" class="w-full p-inputtext p-component" [(ngModel)]="toDateInput" />
                </div>
        ...
        @if (loading()) {
            <app-loading-state message="Tedavi listesi yükleniyor…" />
        } @else if (error()) {
            <div class="card">
                    ...
                    <div class="hidden lg:block overflow-x-auto">
                        ...
                        >
                            ...
                            <ng-template #body let-row>
                                <tr>
                                    <td>{{ formatDateTime(row.treatmentDateUtc) }}</td>
                                    <td>
                                        @if (row.clientId) {
                                    ...
                                    <td>
                                        <a [routerLink]="['/panel/treatments', row.id]" class="text-primary font-medium no-underline">Detay</a>
                                    </td>
                                </tr>
                            </ng-template>
                        </p-table>
                        ...
                        @for (row of displayedRows(); track row.id) {
                            ...
                            >
                                <div class="text-sm font-medium text-surface-900 dark:text-surface-0 min-w-0 mb-3">
                                    {{ formatDateTime(row.treatmentDateUtc) }}
                                </div>
